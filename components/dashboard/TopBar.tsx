          ...
          <AnimatePresence>
            {isProfileOpen && (
              ...
              >
                ...
                <button className="w-full flex items-center space-x-3 px-6 py-3 hover:bg-red-50 dark:hover:bg-red-950/30 text-red-500 transition-colors" onClick={() => window.location.reload()}>
                  <LogOut size={18} />
