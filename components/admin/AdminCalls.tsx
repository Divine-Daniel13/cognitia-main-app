...
import { PhoneIncoming, Activity, Clock, User, ArrowUpRight, CheckCircle, AlertCircle, Search, Filter } from 'lucide-react';
    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <div className="flex items-center space-x-3">
           <button className="px-6 py-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-sm font-bold flex items-center space-x-2">
         ...
         <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
               <div className="relative">
                  ...
                  <input type="text" placeholder="Search sessions..." className="pl-10 pr-4 py-2 rounded-xl bg-slate-50 dark:bg-slate-900 border-none text-sm" />
               </div>
               <button className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800">
                  <Filter size={18} />
               </button>
            </div>
         </div>
